...
$(document).ready(function() {
	...
	$(".close_btn").click(function (e) {
		...
		{
			$(".headerr div").attr('class', 'open_btn');
		}else{
			$(".headerr div").attr('class', 'close_btn');
		}
...
<div class="shout_box">
<div class="headerr">Caja de Chat <div class="close_btn">&nbsp;</div></div>
  <div class="toggle_chat" style="display: none;">
  <div class="message_box">
    </div>
    <div class="user_info">
    <input name="shout_username" id="shout_username" type="text" value="<?=$user_auth_id?>" readonly />
